...
const images = [
  {
    ...
    title: 'Proyecto 4 Patas',
    width: '25%',
    view: '/proyecto4patas',
  },
  {
    url: 'https://scontent.faep14-2.fna.fbcdn.net/v/t39.30808-6/319372099_700622321449115_6216246235730115708_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=a2f6c7&_nc_ohc=X1imEO2ZNqEAX936Bdv&_nc_ht=scontent.faep14-2.fna&oh=00_AfB8lTPoiAMnkDdxo2FGktvykVFI-28dSIQCryxzSGXIJg&oe=65029517',
    title: 'Zaguates Refugio',
    width: '25%',
    view: '/zaguatesrefugio',
  },
  {
        ...
        {images.map((image) => (
            ...
            >
              ...
              <Image>
                ...
                >
                  {image.title}
                  <ImageMarked className='image-marked' />
                </Typography>
              </Image>
            </ImageButton>
            </Link>
