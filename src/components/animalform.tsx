          ...
          <form id='addAnimal'>
            ...
            <FormControl marginBottom={5} isInvalid={errors.breed}>
              ...
              <Input
                ...
                maxLength={20}
              />
              {errors.breed && <FormErrorMessage>{errors.breed}</FormErrorMessage>}
            </FormControl>
            {/* Height */}
            ...
            <FormControl marginBottom={5} isInvalid={errors.rescue_date}>
              ...
              <InputGroup>
                <DatePicker
                  ...
                  onChange={(date)=>handleChange({ target: { name: 'rescue_date', value: date?.toISOString() } })}
                  dateFormat="dd/MM/yyyy"
                />
              </InputGroup>
              {errors.rescue_date && <FormErrorMessage>{errors.rescue_date}</FormErrorMessage>}
            </FormControl>
            {/* Health Rating */}
